...
\lfoot{%\mbox{}
\titlefont\vspace{0.0001\baselineskip}
{{\href{http://intercrossing.wikispaces.com}{INTERCROSSING}} {network} } \\
\titlefont {\itshape\color{Grey-Light} cloud and NGS course}%
}
\cfoot{}
\rfoot{
\titlefont {{\color{Salmon-Dark}oh}{\color{LightAmber-Dark}no}{\color{Grey}sequences}{\color{Salmon-Dark}!} } \\
\titlefont {\color{Grey-Light} era7 bioinformatics R\&D group}%
}
% footer rule
...
\begin{center}
  ...
  \begin{minipage}{.66\textwidth}\center
  \vspace{2\baselineskip}
    {\large\titlefont\itshape
      {Cloud Computing and NGS data analysis}\vspace{0.4\baselineskip}
    }
    {\titlefont\large
      {\href{http://intercrossing.wikispaces.com}{INTERCROSSING} course}
    }
  \end{minipage}
